...
namespace Hotel_Ext.Controllers
{
    public class FacilitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FacilityNo,FacilityName")] Facility facility)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FacilityNo,FacilityName")] Facility facility)
        {
            if (ModelState.IsValid)
            {
